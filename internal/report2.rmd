    ...
    # fig_nB<- paste0("figure_",mycount,"_b")
        ...
        # heatmapchartpath<-paste
          ...
          cat(knit(text = knit_expand(text =
              ...
              \n
      				\n
              if(file.exists(reportchartpath) & !(reportchartpath=='.')){include_graphics(reportchartpath)}
              \n
              if(file.exists(heatmapchartpath) & !(heatmapchartpath=='.')){include_graphics(heatmapchartpath)}
      				\n\n\n
      				kable(kdf)
      				\n\n\n
              cat(cat_stat)
