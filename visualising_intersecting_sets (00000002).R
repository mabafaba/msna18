...
set_intersection_plot<-function(set_percentages){
  ...
  upset(fromExpression(set_percentages), order.by = "freq", nsets = 8, nintersects = 30, mainbar.y.max = 100)
...
data[,which((names(data)) %in% c("food.pin", "wash.pin", "protection.pin", "health.pin", "nfi.shelter.pin", "education.pin", "environment.pin", "livelihoods.pin"))] <- d_num
